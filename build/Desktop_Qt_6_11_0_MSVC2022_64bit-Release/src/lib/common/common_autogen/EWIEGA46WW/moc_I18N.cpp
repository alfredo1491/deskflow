...
void I18N::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->languagesChanged((*reinterpret_cast<std::add_pointer_t<QStringList>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (I18N::*)(const QString )>(_a, &I18N::languageChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (I18N::*)(const QStringList )>(_a, &I18N::languagesChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void I18N::languageChanged(const QString _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void I18N::languagesChanged(const QStringList _t1)
{
