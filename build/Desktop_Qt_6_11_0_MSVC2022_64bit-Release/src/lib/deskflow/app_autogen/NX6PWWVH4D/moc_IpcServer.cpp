...
void deskflow::core::ipc::IpcServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)(const QString & )>(_a, &IpcServer::logLevelChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)(bool )>(_a, &IpcServer::elevateModeChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)(const QString & )>(_a, &IpcServer::commandChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)()>(_a, &IpcServer::startProcessRequested, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)()>(_a, &IpcServer::stopProcessRequested, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (IpcServer::*)()>(_a, &IpcServer::clearSettingsRequested, 5))
            return;
    }
}
...
// SIGNAL 1
void deskflow::core::ipc::IpcServer::elevateModeChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void deskflow::core::ipc::IpcServer::commandChanged(const QString & _t1)
{
