...
#include "../../../../../../../src/lib/gui/widgets/SearchWidget.h"
...
void SearchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->findPrevious((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SearchWidget::*)(const QString & )>(_a, &SearchWidget::findNext, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SearchWidget::*)(const QString & )>(_a, &SearchWidget::findPrevious, 1))
            return;
    }
}
...
// SIGNAL 0
void SearchWidget::findNext(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SearchWidget::findPrevious(const QString & _t1)
{
