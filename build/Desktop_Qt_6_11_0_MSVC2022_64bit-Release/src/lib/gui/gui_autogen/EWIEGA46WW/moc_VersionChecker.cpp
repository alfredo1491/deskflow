...
#include "../../../../../../../src/lib/gui/VersionChecker.h"
...
void VersionChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateFound((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->replyFinished((*reinterpret_cast<std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VersionChecker::*)(const QString & )>(_a, &VersionChecker::updateFound, 0))
            return;
    }
}
