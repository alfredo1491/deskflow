      ...
      m_searchLine{new QLineEdit(this)}
{
  ...
  m_btnToggle->setIcon(resourceActionIcon(QStringLiteral("system-search")));
  m_btnToggle->setIconSize(iconSize);

  m_btnNext->setFixedSize(maxBtnSize);
  m_btnNext->setFlat(true);
  m_btnNext->setIcon(resourceActionIcon(QStringLiteral("go-down")));
  m_btnNext->setIconSize(iconSize);

  m_btnPrev->setFixedSize(maxBtnSize);
  m_btnPrev->setFlat(true);
  m_btnPrev->setIcon(resourceActionIcon(QStringLiteral("go-up")));
