...
#include "../../../../../../../../src/lib/gui/widgets/StatusBar.h"
...
template <> constexpr inline auto StatusBar::qt_create_metaobjectdata<qt_meta_tag_ZN9StatusBarE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "StatusBar",
        "requestShowMyFingerprints",
        "",
        "requestUpdateVersion"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'requestShowMyFingerprints'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'requestUpdateVersion'
...
void StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->requestShowMyFingerprints(); break;
        case 1: _t->requestUpdateVersion(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StatusBar::*)()>(_a, &StatusBar::requestShowMyFingerprints, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StatusBar::*)()>(_a, &StatusBar::requestUpdateVersion, 1))
            return;
    }
}
...
// SIGNAL 0
void StatusBar::requestShowMyFingerprints()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void StatusBar::requestUpdateVersion()
{
