...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy5.setHeightForWidth(btnConfigureServer->sizePolicy().hasHeightForWidth());
        btnConfigureServer->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(btnConfigureClient->sizePolicy().hasHeightForWidth());
        btnConfigureClient->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(btnToggleCore->sizePolicy().hasHeightForWidth());
        btnToggleCore->setSizePolicy(sizePolicy5);
