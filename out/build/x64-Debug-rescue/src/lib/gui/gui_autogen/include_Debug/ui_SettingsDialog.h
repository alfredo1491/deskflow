...
public:
    ...
    QGroupBox *groupFileTransfer;
    QFormLayout *formLayoutFileTransfer;
    QLabel *lblTransferPort;
    QSpinBox *sbTransferPort;
    QLabel *lblReceiveDirectory;
    QWidget *widgetReceiveDirectory;
    QHBoxLayout *horizontalLayoutReceiveDirectory;
    QLineEdit *lineReceiveDirectory;
    QPushButton *btnBrowseReceiveDirectory;
    QLabel *lblApprovedPeers;
    QLineEdit *lineApprovedPeers;
    ...
    QWidget *widgetWlClipboard;
    QVBoxLayout *verticalLayout_5;
    QCheckBox *cbUseWlClipboard;
    QLabel *lblWlClipboard;
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        groupFileTransfer = new QGroupBox(tabNetwork);
        groupFileTransfer->setObjectName("groupFileTransfer");
        formLayoutFileTransfer = new QFormLayout(groupFileTransfer);
        formLayoutFileTransfer->setObjectName("formLayoutFileTransfer");
        lblTransferPort = new QLabel(groupFileTransfer);
        lblTransferPort->setObjectName("lblTransferPort");

        formLayoutFileTransfer->setWidget(0, QFormLayout::ItemRole::LabelRole, lblTransferPort);

        sbTransferPort = new QSpinBox(groupFileTransfer);
        sbTransferPort->setObjectName("sbTransferPort");
        sbTransferPort->setMinimum(1024);
        sbTransferPort->setMaximum(65535);
        sbTransferPort->setValue(24801);

        formLayoutFileTransfer->setWidget(0, QFormLayout::ItemRole::FieldRole, sbTransferPort);

        lblReceiveDirectory = new QLabel(groupFileTransfer);
        lblReceiveDirectory->setObjectName("lblReceiveDirectory");

        formLayoutFileTransfer->setWidget(1, QFormLayout::ItemRole::LabelRole, lblReceiveDirectory);

        widgetReceiveDirectory = new QWidget(groupFileTransfer);
        widgetReceiveDirectory->setObjectName("widgetReceiveDirectory");
        horizontalLayoutReceiveDirectory = new QHBoxLayout(widgetReceiveDirectory);
        horizontalLayoutReceiveDirectory->setSpacing(3);
        horizontalLayoutReceiveDirectory->setObjectName("horizontalLayoutReceiveDirectory");
        horizontalLayoutReceiveDirectory->setContentsMargins(0, 0, 0, 0);
        lineReceiveDirectory = new QLineEdit(widgetReceiveDirectory);
        lineReceiveDirectory->setObjectName("lineReceiveDirectory");

        horizontalLayoutReceiveDirectory->addWidget(lineReceiveDirectory);

        btnBrowseReceiveDirectory = new QPushButton(widgetReceiveDirectory);
        btnBrowseReceiveDirectory->setObjectName("btnBrowseReceiveDirectory");
        btnBrowseReceiveDirectory->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        btnBrowseReceiveDirectory->setIcon(icon);
        btnBrowseReceiveDirectory->setFlat(true);

        horizontalLayoutReceiveDirectory->addWidget(btnBrowseReceiveDirectory);


        formLayoutFileTransfer->setWidget(1, QFormLayout::ItemRole::FieldRole, widgetReceiveDirectory);

        lblApprovedPeers = new QLabel(groupFileTransfer);
        lblApprovedPeers->setObjectName("lblApprovedPeers");

        formLayoutFileTransfer->setWidget(2, QFormLayout::ItemRole::LabelRole, lblApprovedPeers);

        lineApprovedPeers = new QLineEdit(groupFileTransfer);
        lineApprovedPeers->setObjectName("lineApprovedPeers");

        formLayoutFileTransfer->setWidget(2, QFormLayout::ItemRole::FieldRole, lineApprovedPeers);


        verticalLayout_7->addWidget(groupFileTransfer);
        ...
        widgetWlClipboard = new QWidget(tabAdvanced);
        widgetWlClipboard->setObjectName("widgetWlClipboard");
        verticalLayout_5 = new QVBoxLayout(widgetWlClipboard);
        verticalLayout_5->setObjectName("verticalLayout_5");
        cbUseWlClipboard = new QCheckBox(widgetWlClipboard);
        cbUseWlClipboard->setObjectName("cbUseWlClipboard");

        verticalLayout_5->addWidget(cbUseWlClipboard);

        lblWlClipboard = new QLabel(widgetWlClipboard);
        lblWlClipboard->setObjectName("lblWlClipboard");
        lblWlClipboard->setWordWrap(true);

        verticalLayout_5->addWidget(lblWlClipboard);


        verticalLayout_4->addWidget(widgetWlClipboard);
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        comboLogLevel->setItemText(0, QCoreApplication::translate("SettingsDialog", "Fatal", nullptr));
        comboLogLevel->setItemText(1, QCoreApplication::translate("SettingsDialog", "Error", nullptr));
        comboLogLevel->setItemText(2, QCoreApplication::translate("SettingsDialog", "Warning", nullptr));
        comboLogLevel->setItemText(3, QCoreApplication::translate("SettingsDialog", "Note", nullptr));
        comboLogLevel->setItemText(4, QCoreApplication::translate("SettingsDialog", "Info", nullptr));
        comboLogLevel->setItemText(5, QCoreApplication::translate("SettingsDialog", "Debug", nullptr));
        comboLogLevel->setItemText(6, QCoreApplication::translate("SettingsDialog", "Debug1", nullptr));
        comboLogLevel->setItemText(7, QCoreApplication::translate("SettingsDialog", "Debug2", nullptr));
        ...
        lblDebugWarning->setText(QCoreApplication::translate("SettingsDialog", "Using a Debug log level may affect performance. Only use a Debug level if you are attempting to debug an issue or are gathering logs to submit with a bug report.", nullptr));
        ...
        groupFileTransfer->setTitle(QCoreApplication::translate("SettingsDialog", "File Transfer", nullptr));
        lblTransferPort->setText(QCoreApplication::translate("SettingsDialog", "P2P port", nullptr));
        lblReceiveDirectory->setText(QCoreApplication::translate("SettingsDialog", "Receive folder", nullptr));
        btnBrowseReceiveDirectory->setText(QString());
        lblApprovedPeers->setText(QCoreApplication::translate("SettingsDialog", "Approved peers", nullptr));
        lineApprovedPeers->setPlaceholderText(QCoreApplication::translate("SettingsDialog", "One host/IP per entry, separated by commas", nullptr));
        ...
        cbUseWlClipboard->setText(QCoreApplication::translate("SettingsDialog", "Enable wl-clipboard support", nullptr));
        lblWlClipboard->setText(QCoreApplication::translate("SettingsDialog", "<html><head/><body><p>Requires the wl-clipboard package</p><p>When using wl-clipboard v2.2.1, there is a focus stealing bug that may make Deskflow harder to use. This has been fixed when using the wl-clipboard master branch, unless your Compositor lacks wlroots-data-control protocol support.</p></body></html>", nullptr));
