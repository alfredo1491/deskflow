...
#include "../../../../../../../../../src/lib/gui/widgets/TrashScreenWidget.h"
...
void TrashScreenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->screenRemoved(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrashScreenWidget::*)()>(_a, &TrashScreenWidget::screenRemoved, 0))
            return;
    }
}
...
// SIGNAL 0
void TrashScreenWidget::screenRemoved()
{
